...
const ClientQuestion = () => {
    return (
        <div>
            <section className="mt-10 max-w-[1240px] mx-auto px-5 lg:px-0">
                <div
                    className="text-center  space-y-2 ">
                    <p className='text-gray-600'>FAQ</p>
                    <h1 className="text-3xl text-[#421b01] font-bold font-Rancho">
                        Clients Question
                    </h1>
                ...
                <div
                    ...
                    <div className="pt-5 lg:flex-1 font-Cormorrant">
                        <details className="collapse collapse-plus">
                            <summary className="collapse-title text-2xl text-black focus:bg-[#421b01] focus:text-white  font-bold">
